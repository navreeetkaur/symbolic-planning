...
python planner.py  --world .\jsons\home_worlds\world_home1.json --goal .\jsons\home_goals\goal4.json --input part5 > "testLogs\part5\output_G4_W1.txt"
...
rem python planner.py  --world .\jsons\home_worlds\world_home3.json --goal .\jsons\home_goals\goal3.json --input part5 > "testLogs\part5\output_G3_W3.txt"
